...
export const whatWeDoPageData = {
  ...
  whatWedodata: {
    title: "What we do",
    subTitle: "exceptional Moulding Manufacturer",
    desc: [
      "Stucco Décor; where craftsmanship meets innovation in the world of EPS moulding manufacturing. We take pride in our dedication to quality, precision, and design excellence. With years of experience and a commitment to customer satisfaction, we specialize in creating stunning stucco moulding products that elevate any space.",
  ...
  briefHistory: {
    ...
    desc: [
      "The use of exterior moulding in architecture dates back thousands of years, with its history spanning across various civilizations and architectural styles. Here’s a brief overview of the historical significance and evolution of exterior moulding:",
  ...
  introductionToMaterial: {
    ...
    desc: [
      "Overall, EPS exterior moulding offers a combination of versatility, durability, energy efficiency, and cost-effectiveness, making it an attractive option for architects, builders, and homeowners seeking high-performance architectural trim solutions. EIFS, or Exterior Insulation and Finish System, is a popular type of cladding system that provides excellent insulation and moisture protection for buildings. The use of EIFS exterior mouldings can enhance the aesthetic appeal of any building while also providing additional insulation and protection against the elements.",
      "As a manufacturer of EIFS exterior mouldings, it’s important to ensure that our products meet high standards of quality and durability. This will help to ensure that our clients are satisfied with the products they receive and that they will continue to use our services in the future. Additionally, it’s important to stay up-to-date with industry trends and developments in order to remain competitive in the market.",
    ],
    cards: [
      {
        id: 1,
  ...
  manufacturingProcess: {
    ...
    desc: [
      "Stucco Décor mouldings offer pre-coated unique shapes starting with an expanded polystyrene core and reinforced with fiberglass reinforcing mesh, followed by 2 coats of an extrusion process of cementitious coating.",
...
export const exteriorProductspageData = {
  bannerData: {
...
export const contactPageData = {
  ...
  map: "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d23089.949304061007!2d-79.642846!3d43.663902!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b38d6210228fd%3A0x9cb93abf156cd04a!2zTi9B!5e0!3m2!1sen!2sus!4v1742751356973!5m2!1sen!2sus",
};

export const getCustomQuotationPageData = {
  bannerData: {
